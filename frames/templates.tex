...
Alternatively, to make the background 50\% transparent, you can write \texttt{\textbackslash framepic[0.5]\{pictures/darth\}...}
...
\framepic{pictures/darth}{
    \framefill
    \textcolor{white}{Luke,\\I am your supervisor}
    \vskip 0.5cm
}

\framepic[0.5]{pictures/darth}{
    \vfill
    \begin{flushright}
